<ul>
    ...
    <li><a href="<?php print get_home_url(); ?>/elements">Elements</a></li>   
    <li><a href="<?php print get_home_url(); ?>/resources">Resources</a></li>   
    <li><a href="<?php print get_home_url(); ?>/about">About</a>        
    <li><a href="<?php print get_home_url(); ?>/advertise">Advertise</a>             
