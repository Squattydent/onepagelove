...
<ul>
    ...
    <?php 
	    ...
	    $nav_template_variable = wp_list_categories('echo=0&title_li=&sort_column=name&optioncount=0&exclude=' . $free_template_id . '&hierarchical=0&child_of=' . $nav_template_id . '');
