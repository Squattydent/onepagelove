	...
	<div id="footer-container">
		...
		<div id="footer-newsletter">
			...
			<div class="newsletter-title">Subscribe to the One Page Love Newsletter</div>
			...
			<div class="newsletter-lower-wrapper">
				...
				<div class="newsletter-pitch">
					...
					<ul>
						<li class="tick">Once a month, 100% free</li>
						<li class="tick">Inspiration, resources, freebies</li>
						<li class="tick">Unsubscribe instantly</li>
						<li class="tick">Free website design tip eBook</li>
					</ul>
				...
				<div class="newsletter-form">
					...
					<div class="email-octopus-form-wrapper">
						...
						<div class="email-octopus-form-row" style="display: block;">
