			...
			<div id="footer-newsletter">
				...
				<div class="newsletter-lower-wrapper">
					...
					<div class="newsletter-ebook">
						...
						<img src="<?php echo get_template_directory_uri(); ?>/img/footer-ebook.jpg" alt="10 Quick Tips to tighten your Landing Page design" width="500" height="375" />
		...
		<div id="footer-bottom-container">		
			...
			<div id="footer-bottom">
				...
				<div id="footer-links">
					...
					<ul>
						<li><a href="<?php print get_home_url(); ?>">Home</a></li> 
				...
				<div id="footer-social">	
					...
					<a class="sub-t" href="https://twitter.com/onepagelove">
					...
					<a class="sub-f" href="https://facebook.com/onepagelove">
						<svg class="svg-icon" viewBox="0 0 20 20">
							<path fill="none" d="M11.344,5.71c0-0.73,0.074-1.122,1.199-1.122h1.502V1.871h-2.404c-2.886,0-3.903,1.36-3.903,3.646v1.765h-1.8V10h1.8v8.128h3.601V10h2.403l0.32-2.718h-2.724L11.344,5.71z"></path>
						</svg>
					</a>

					<a class="sub-p" href="https://pinterest.com/onepagelove">
						<svg class="svg-icon" viewBox="0 0 20 20">
					...
					<a class="sub-g" href="https://plus.google.com/101808922664177427937">
						<svg class="svg-icon" viewBox="0 0 20 20">
					...
					<a class="sub-d" href="https://dribbble.com/hitdelete/projects/415145-One-Page-Love">
						<svg class="svg-icon" viewBox="0 0 20 20">
					...
					<a class="sub-r" href="https://onepagelove.com/feed">
						<svg viewBox="0 0 64 64">
							<circle cx="21" cy="43" r="5"/><path d="M35,48.5A2.5,2.5,0,0,1,32.5,46,13.515,13.515,0,0,0,19,32.5a2.5,2.5,0,0,1,0-5A18.521,18.521,0,0,1,37.5,46,2.5,2.5,0,0,1,35,48.5Z"/><path d="M45,48.5A2.5,2.5,0,0,1,42.5,46,23.527,23.527,0,0,0,19,22.5a2.5,2.5,0,0,1,0-5A28.532,28.532,0,0,1,47.5,46,2.5,2.5,0,0,1,45,48.5Z"/>
						</svg>
					</a>
