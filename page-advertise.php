...
<?php get_header(); ?>
	...
	<div class="pages sponsored-posts">
		...
		<img src="<?php echo get_template_directory_uri(); ?>/img/advertise/intro.jpg" alt="One Page Love Sponsored Post" />
		...
		<div class="section section-padding section-features"  id="title-features">
			...
			<div class="section-grey">
				...
				<div class="features">
					...
					<div class="feature">
						<div class="feature-image"><img src="<?php echo get_template_directory_uri(); ?>/img/advertise/features/1.jpg" /></div>
						<div class="feature-copy"><h3>1 x Dedicated Blog Post</h3><p>The article will say you are this weeks sponsor, talking about brand and why our readers would benefit using your product or service. <a href="/sponsored">See Examples</a></p></div>
					</div>
					...
					<div class="feature">
						...
						<div class="feature-image"><img src="<?php echo get_template_directory_uri(); ?>/img/advertise/features/2.jpg" /></div>
					</div>

					<div class="feature">			
						<div class="feature-image"><img src="<?php echo get_template_directory_uri(); ?>/img/advertise/features/3.jpg" /></div>
						<div class="feature-copy"><h3>1 x Tweet to 4k followers</h3><p>A thank you using your companies Twitter handle. <a href="https://twitter.com/OnePageLove/status/667346681239879680" target="_blank">See Example</a></p></div>
					</div>
					...
					<div class="feature">			
						...
						<div class="feature-image"><img src="<?php echo get_template_directory_uri(); ?>/img/advertise/features/4.jpg" /></div>

					</div>

					<div class="feature">			
						<div class="feature-image"><img src="<?php echo get_template_directory_uri(); ?>/img/advertise/features/5.jpg" /></div>
						<div class="feature-copy"><h3>1 Week on our Home Page</h3><p>The Sponsored Post will sit in our highest traffic area for no less than one week. This gaurentees maxium exposure.</p></div>
					</div>

					<div class="feature">		
						<div class="feature-copy"><h3>Exposure to 4k RSS Readers</h3><p>Your Sponsored Post will arrive in the feed of 4k RSS Readers.</p></div>
						<div class="feature-image"><img src="<?php echo get_template_directory_uri(); ?>/img/advertise/features/6.jpg" /></div>
					</div>
		...
		<div class="section section-padding section-stats" id="title-stats">
			...
			<div class="section-gradient">	
				...
				<div class="section-buttons">
					...
					<div class="button"><a href="<?php echo get_template_directory_uri(); ?>/img/advertise/onepagelove-analytics.pdf" target="_blank">Download PDF</a></div>
		...
		<img src="<?php echo get_template_directory_uri(); ?>/img/advertise/stats.jpg" alt="One Page Love statistics" />
		...
		<div class="section section-padding section-demographics" id="title-demographics">
			...
			<div class="section-gradient">	
				...
				<div class="section-buttons">
					...
					<div class="button"><a href="<?php echo get_template_directory_uri(); ?>/img/advertise/onepagelove-demographics.pdf" target="_blank">Download PDF</a></div>
		...
		<img src="<?php echo get_template_directory_uri(); ?>/img/advertise/demographics.jpg" alt="One Page Love statistics" />
		...
		<div class="section section-padding section-features"  id="title-stats">
			...
			<div class="section-grey">
				...
				<div class="features">
					...
					<div class="feature">
						<div class="feature-image"><a href="https://onepagelove.com/optimizer-landing-page-builder"><img src="<?php echo get_template_directory_uri(); ?>/img/advertise/features/7.jpg" /></a></div>
					...
					<div class="feature">
						...
						<div class="feature-image"><a href="https://onepagelove.com/zerif-lite-by-themeisle"><img src="<?php echo get_template_directory_uri(); ?>/img/advertise/features/8.jpg" /></a></div>
					</div>

					<div class="feature">			
						<div class="feature-image"><a href="https://onepagelove.com/how-to-build-a-landing-page-in-less-than-an-hour-with-wix"><img src="<?php echo get_template_directory_uri(); ?>/img/advertise/features/9.jpg" /></a></div>
					...
					<div class="feature">
						...
						<div class="feature-image"><a href="https://onepagelove.com/woocommerce-one-page-checkout"><img src="<?php echo get_template_directory_uri(); ?>/img/advertise/features/10.jpg" /></a></div>
					</div>

					<div class="feature">			
						<div class="feature-image"><a href="https://onepagelove.com/why-we-host-with-wp-engine"><img src="<?php echo get_template_directory_uri(); ?>/img/advertise/features/11.jpg" /></a></div>
